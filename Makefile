...
$(IMG) : $(OUTPUT_DIR)/ipl.bin $(OUTPUT_DIR)/haribote.sys fonts/nihongo.fnt $(OUTPUT_DIR)/prim.hrb $(OUTPUT_DIR)/lines.hrb $(OUTPUT_DIR)/timer.hrb $(OUTPUT_DIR)/beepdown.hrb $(OUTPUT_DIR)/color.hrb $(OUTPUT_DIR)/iroha.hrb $(OUTPUT_DIR)/cat.hrb $(OUTPUT_DIR)/chklang.hrb $(OUTPUT_DIR)/notrec.hrb Makefile
